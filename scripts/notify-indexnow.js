...
// --- Konfigurasi Anda ---
const YOUR_DOMAIN = 'https://bokepjilbababg.pages.dev'; // Ganti dengan domain Anda yang sebenarnya
const API_KEY_NAME = 'f3be49a5-cff6-4fdd-a3aa-b4f793561b69'; // Ganti dengan GUID Anda
